...
public class MediaBrowserAutoConnection {
  private final Context context;
  private static String TAG = "MediaBrowserAutoConnection";
  ...
  public void setListener(OnCarConnectionStateListener listener) {
    MediaBrowserAutoConnection.listener = listener;
  }

  public MediaBrowserAutoConnection(Context context) {
